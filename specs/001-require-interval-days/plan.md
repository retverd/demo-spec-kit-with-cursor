...
**Testing**: `pytest` + `pytest-mock`; мокирование HTTP/ФС в unit, интеграционные проверки CLI. Отдельно Phase 6: реальные прогоны CBR/MOEX (T022/T023) и регрессия форматов/имен файлов (T024); граничные кейсы 365/високосный день покрываются T025.
...
- ✅ Добавлена Phase 6 с задачами T022/T023/T024 на реальные прогоны и регрессию форматов после обязательного `--days`.
